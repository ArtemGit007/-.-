...
**Задача 106** Составить программу, которая читает натуральное число N в десятичном представлении (N < 10000), а на выходе выдает это же число в десятичном представлении и на естественном языке. Например, 7 => семь; 204 => двести четыре; 52 => пятьдесят два. У этого ршешения большой потенциал, и с увеличением объёмап заний мы будем возвращаться к ней и оптимизировать его.[Вариант решения]((https://github.com/ArtemGit007/Programming-tasks-/blob/master/Задача%20106/Program.cs))
