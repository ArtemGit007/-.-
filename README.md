...
**Задача 43** аны три стороны одного и три стороны другого треугольника. Написать программу определения , будут ли эти треугольники равновеликими, т.е. имеют ли они равные площади.([Вариант решения](https://github.com/ArtemGit007/Programming-tasks-/blob/master/Задача%2043/Program.cs))
