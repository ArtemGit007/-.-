...
**Задача 76** Дано натуральное число N. Если оно делится на 5, вывести на экран ответ N = 5k (где k – соответствующее частное); если остаток от деления на 5 равен 1, N = 5k + 1; если остаток от деления на 5 равен 2, N = 5k + 2; если остаток от деления на 5 равен 3, N = 5k + 3; если остаток от деления на 5 равен 4, N = 5*k + 4.([Вариант решения](https://github.com/ArtemGit007/Programming-tasks-/blob/master/Задача%2076/Program.cs))

**Задача 77** Дано натуральное число N. Если оно делится на 7, вывести на экран ответ N = 5k (где k – соответствующее частное); если остаток от деления на 7 равен 1, N = 7k + 1; если остаток от деления на 7 равен 2, N = 7k + 2; если остаток от деления на 7 равен 3, N = 7k + 3; если остаток от деления на 7 равен 4, N = 7*k + 4. ([Вариант решения](https://github.com/ArtemGit007/Programming-tasks-/blob/master/Задача%2077/Program.cs))

**Задача 78** Дано целое число k (1 <= k <= 365). Определить, каким днем недели (понедельником, вторником, ..., субботой или воскресеньем) является k-й день невисокосного года, в котором 1 января понедельник. ([Вариант решения](https://github.com/ArtemGit007/Programming-tasks-/blob/master/Задача%2078/Program.cs))

**Задача 79** Дата некоторого дня характеризуется двумя натуральными числами: m (порядковый номер месяца) и n (число). По заданным n и m определить дату предыдущего дня (принять, что n и m не характеризуют 1 января). Примечание: принять, что год не является високосным.([Вариант решения] (https://github.com/ArtemGit007/Programming-tasks-/blob/master/Задача%2079/Program.cs))

**Задача 80** Дата некоторого дня характеризуется двумя натуральными числами: m (порядковый номер месяца) и n (число). По заданным n и m определить: дату следующего дня (принять, что n и m не характеризуют 31 декабря). Примечание: принять, что год не является високосным. ([Вариант решения](https://github.com/ArtemGit007/Programming-tasks-/blob/master/Задача%2080/Program.cs))
